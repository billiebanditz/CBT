...
<body style="background: url('<?= $setting['bc'] ?>');background-size:cover;background-position: center;background-repeat: no-repeat;">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="animated flipInX wrap-login100" style="padding-top:60px">
				<form id="formlogin" action="ceklogin.php" class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate="Enter Username" required>
						...
						<span class="focus-input100" data-placeholder="Input Username"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate="Enter password">
						...
						<span class="focus-input100" data-placeholder="Input Password"></span>
					</div>
					...
					<div class="container-login100-form-btn">
						...
						<p><small>Support Aplikasi By Dhika Saputra</small></p>
					</div>
