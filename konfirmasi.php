    ...
    <div class='col-md-6'>
        <div class='box box-solid'>
            <div class='box-header'>
                <h3 class='box-title'>Konfirmasi Test</h3>
                        ...
                        <table class='table no-margin'>
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <b>Jumlah Soal</b><br />
                                        <small class='label bg-purple'><?= $namamapel['tampil_pg'] . ' Pilihan Ganda / ' . $namamapel['tampil_esai'] ?> Esai</small>
                                    </td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td>
                                        <b>Tanggal Waktu Test</b><br />
