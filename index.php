        ...
        <aside class='main-sidebar'>
            <section class='sidebar'>
                ...
                <ul class='sidebar-menu tree' data-widget='tree'>
                    <li class='header'>Main Menu Peserta Test</li>
                    <li><a href='<?= $homeurl ?>'><i class='fas fa-tachometer-alt fa-fw  '></i> <span> Dashboard</span></a></li>
                    <li><a href='<?= $homeurl ?>/jadwal'><i class='fas fa-calendar fa-fw  '></i> <span> Jadwal Test</span></a></li>
                    ...
                    <li><a href='<?= $homeurl ?>/hasil'><i class='fas fa-tags fa-fw '></i> <span> Hasil Test</span></a></li>
                </ul><!-- /.sidebar-menu -->
            </section>
        </aside>
                    ...
                    <div class='row'>
                        <div class='col-md-12'>
                            <div class='alert alert-info alert-dismissible'>
                                ...
                                Tombol test akan aktif bila waktu sudah sama dengan jadwal test,
                                Refresh browser atau tekan F5 jika waktu test belum aktif
                                </div>
                        </div>
                        <div id="boxtampil" class='col-md-12'>
                            <div id='formjadwalujian' class='box box-solid'>
                                <div class='box-header with-border'>
                                    <h3 class='box-title'><i class="fas fa-calendar-alt    "></i> Jadwal Test Hari ini</h3>
                                    <!-- <div class='box-tools'>
                                ...
                                <div class='box-body'>
                                    ...
                                    $mapelQ = mysqli_query($koneksi, "SELECT * FROM ujian WHERE (level='$level' or level='semua') AND sesi='$idsesi' AND status='1' ORDER BY kode_nama ");
                                                ...
                                                <?php if (in_array($siswa['id_kelas'], $datakelas) or in_array('semua', $datakelas)) : ?>
                                                    ...
                                                    if ($nilai['ujian_selesai'] == '' and $ceknilai_temp == 0) :
                                                        ...
                                                        elseif (strtotime($mapelx['tgl_ujian']) >= time() and time() <= strtotime($mapelx['tgl_selesai'])) :
                                                            ...
                                                            $btntest = "<button' class='btn btn-block btn-sm btn-danger disabled'> BELUM Test</button>";
                                                        else :
                                                            $status = '<label class="label label-danger">Telat Test</label>';
                                                            $btntest = "<button' class='btn btn-block btn-sm btn-danger disabled'> Telat Test</button>";
                                                        endif;
                                                    else :
                                                        if ($nilai_temp['ujian_mulai'] <> '' and $nilai_temp['ujian_berlangsung'] <> '' and $nilai_temp['ujian_selesai'] == '') :
                                                            ...
                                                            if ($nilai['ujian_mulai'] <> '' and $nilai['ujian_berlangsung'] <> '' and $nilai['ujian_selesai'] <> '') {
                                                                ...
                                                                $btntest = "<button class='btn btn-block btn-success btn-sm disabled'> Sudah Test</button>";
                                                                }else{
                ...
                <?php elseif ($pg == 'hasil') : ?>
                    <div class='row'>
                        <div class='col-md-12'>
                            <div class='box box-solid'>
                                <div class='box-header with-border'>
                                    <h3 class='box-title'><i class="fas fa-file-signature    "></i> Data Hasil Test</h3>
                                </div><!-- /.box-header -->
                                <div class='box-body'>
                                    <div class="nav-tabs-custom">
                                        <ul class="nav nav-tabs">
                                            <li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="true">Hasil Test</a></li>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="tab_1">
                                                <div class="alert alert-info" role="alert">
                                                    <strong>Daftar Test yang sudah dikerjakan</strong>
                                                </div>
                                                <table id='example1' class='table table-bordered table-striped'>
                                                    <thead>
                                                        <tr>
        ...
        <footer class='main-footer hidden-xs'>
            <div class='container'>
                <div class='pull-left hidden-xs'>
                    <strong>
                        <span id='end-sidebar'>
                            &copy; 2025 <?= APLIKASI . " v" . VERSI . " r" . REVISI ?>
                        </span>
                    </strong>
                </div>
        </footer>
